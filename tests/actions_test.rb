...
class ActionsTest < Minitest::Test
    ...
    def test_snake_grow
        #Posicionamos la serpiente para que el siguiente movimiento sea hacia la coordenada comida 
        # al expected state se le agrego una nueva cola  ya que la si la serpiete come debe crecer
        initial_state = Model::State.new(
            Model::Snake.new([
                Model::Coord.new(1,1),
                Model::Coord.new(0,1)
